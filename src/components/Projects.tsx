                ...
                <div className="bg-card rounded-2xl overflow-hidden hover-glow transition-all border border-border h-full flex flex-col">
                  ...
                  <div className="relative aspect-video overflow-hidden bg-muted">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                      <span className="text-white font-medium px-4 py-2 border border-white/30 rounded-full bg-white/10 backdrop-blur-md hover:bg-white/20 transition-colors">View Details</span>
                      {project.liveUrl && (
                        <a
                          ...
                          className="text-white font-medium px-4 py-2 border border-primary/50 rounded-full bg-primary/80 backdrop-blur-md hover:bg-primary transition-colors flex items-center gap-2"
                          title="Live Preview"
                        >
